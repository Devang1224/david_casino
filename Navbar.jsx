    ...
    <nav className="w-full bg-appBlack h-[90px]">
      <div className="flex items-center justify-between p-2 md:ml-20 md:mr-20">
        ...
        <div className="flex items-center">
          ...
          {/* New menu items */}
          <button className="hidden md:inline-block py-7 border-b-[2px] border-transparent hover:border-b-appBlue group">
            <p className="px-4 text-[13px] text-textGrey group-hover:text-white transition-colors duration-200 cursor-pointer">CHANGE ACCOUNT</p>
          </button>
          <button className="hidden md:inline-block py-7 border-b-[2px] border-transparent hover:border-b-appBlue group">
            <p className="px-4 text-[13px] text-textGrey group-hover:text-white transition-colors duration-200 cursor-pointer">AFFILIATES</p>
          </button>
          <button className="hidden md:inline-block py-7 border-b-[2px] border-transparent hover:border-b-appBlue group">
            <p className="px-4 text-[13px] text-textGrey group-hover:text-white transition-colors duration-200 cursor-pointer">CONTESTS</p>
          </button>
          <button className="hidden md:inline-block py-7 border-b-[2px] border-transparent hover:border-b-appBlue group">
            <p className="px-4 text-[13px] text-textGrey group-hover:text-white transition-colors duration-200 cursor-pointer">STORE</p>
          </button>
          <button className="hidden md:inline-block py-7 border-b-[2px] border-transparent hover:border-b-appBlue group">
            <p className="px-4 text-[13px] text-textGrey group-hover:text-white transition-colors duration-200 cursor-pointer">PROVABLY FAIR</p>
          </button>
